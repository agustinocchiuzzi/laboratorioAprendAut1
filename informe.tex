...
Los árboles repiten el patrón de los empates:
\[
C_{\mathrm{ID3}}=
...
Las observaciones describen una evaluación secuencial con 2025 incompleto, no una predicción simultánea de dos años ni evidencia causal. Ningún resultado de test modificó atributos, suavizado o decisiones. Con la evaluación de los árboles, la comparación global queda cerrada para este test. El árbol de sklearn sobre los mismos códigos es el único que supera la accuracy del NB (0,4682 frente a 0,4619), pero el mejor macro-F1 sigue siendo el del NB (0,4281): los árboles y el bosque ceden cohesión en las clases minoritarias. El ID3 propio queda casi igualado con su versión de sklearn (0,4661 y 0,4027 frente a 0,4682 y 0,4109), lo que valida la implementación, y el bosque (0,4386 y 0,4085) reparte mejor la clase E pero paga accuracy. La discretización de las tasas es decisiva: el mismo árbol sobre valores continuos cae a 0,3602 de accuracy, el peor de la tabla. Ningún modelo logra un recall de empate mayor a 0,26 (de 0,1374 del ID3 a 0,2366 del bosque), así que el empate sigue siendo la dificultad compartida que ningún clasificador resuelve.
